...
/**
 * Provides the local service interface for Field. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LiferayFarmer
 * @see FieldLocalServiceUtil
...
public interface FieldLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link FieldLocalServiceUtil} to access the field local service. Add custom service methods to {@link com.meera.dbservice.service.impl.FieldLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
